...
public class CruderConstant extends Msg{
    ...
    public final static String ID = NODE_ID;
    ...
    public final static String CODE = NODE_CODE;
    public final static String NAME = NODE_NAME;
    public final static String LABEL = NODE_LABEL;
